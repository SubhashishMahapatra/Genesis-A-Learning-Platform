...
public class BookIssueForm extends javax.swing.JFrame {
    ...
    private library retrieveData(String id) {
        String qry = null;
        library tTable = null;

        try {
            qry = "SELECT * FROM library WHERE id LIKE '%" + id + "%'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(qry);
            if (rs.next()) {
                tTable = new library(rs.getString("id"), rs.getString("subject"), rs.getString("student"), rs.getString("course"),
    ...
    public void showItemToFields(String id) {
        final library data = retrieveData(id);
        ...
        ArrayList<String> studentList = DBFunctions.getStudent(data.getCourse());
        if (studentList.isEmpty()) {
            studentList.add("Select");
        }
        StudentComboBox.setModel(new DefaultComboBoxModel<>(studentList.toArray(new String[0])));
        ...
        StudentComboBox.setSelectedItem(data.getStudent());
	...
	public BookIssueForm(Role role) {
        this.role = role;
        initComponents();
        customizeComponents();
    }
    ...
    private void initComponents() {
        ...
        StudentLoadingButton = new javax.swing.JButton();
        ...
        TitleLabel.setText("BOOK ISSUE FORM");
        ...
        StudentComboBox.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        StudentLoadingButton.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        StudentLoadingButton.setForeground(new java.awt.Color(0, 150, 150));
        StudentLoadingButton.setText("Load");
        StudentLoadingButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        StudentLoadingButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                StudentLoadingButtonMousePressed(evt);
            }
        });
        ...
        BodyPanelLayout.setHorizontalGroup(
            ...
            .addGroup(BodyPanelLayout.createSequentialGroup()
                ...
                .addGroup(BodyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(BodyPanelLayout.createSequentialGroup()
                        .addComponent(StudentComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(StudentLoadingButton))
        ...
        BodyPanelLayout.setVerticalGroup(
            ...
            .addGroup(BodyPanelLayout.createSequentialGroup()
                ...
                .addGroup(BodyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(StudentComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(StudentLoadingButton, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(BodyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
            ...
            if (CourseComboBox.getSelectedItem() == null || CourseComboBox.getSelectedItem() == "Select") {
            ...
            } else if (StudentComboBox.getSelectedItem() == null || StudentComboBox.getSelectedItem() == "Select") {
                JOptionPane.showMessageDialog(null, "Student Field Is Required!!!");
                ...
                final String insert_sql = "INSERT INTO library(subject, student, "
                ...
                try {
                    ...
                    ps.setString(2, StudentComboBox.getSelectedItem().toString());
    ...
    private void UpdateButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UpdateButtonMousePressed
            ...
            if (CourseComboBox.getSelectedItem() == null || CourseComboBox.getSelectedItem() == "Select") {
                ...
                final String insert_sql = "UPDATE library SET subject=?, student=?, "
    ...
    private void DeleteButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteButtonMousePressed
            ...
            if (!UIDTextField.getText().isEmpty()) {
                ...
                try {
                    String qry = "DELETE FROM library WHERE id LIKE '%" + uid + "%'";
    ...
    private void StudentLoadingButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StudentLoadingButtonMousePressed
        ArrayList<String> studentList = DBFunctions.getStudent(CourseComboBox.getSelectedItem().toString());
        if (studentList.isEmpty()) {
            studentList.add("Select");
        }
        StudentComboBox.setModel(new DefaultComboBoxModel<>(studentList.toArray(new String[0])));
    }//GEN-LAST:event_StudentLoadingButtonMousePressed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new BookIssueForm(role).setVisible(true);
        });
    }
    ...
    private javax.swing.JButton StudentLoadingButton;
