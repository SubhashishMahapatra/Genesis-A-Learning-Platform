...
public class LoginScreen extends javax.swing.JFrame {
	...
	private GraphicsConfiguration role;
    ...
    private void loginAdmin(java.awt.event.ActionEvent event) {
        if (UsernameTextField.getText().isBlank()) {
            ...
            String admin_sql = "SELECT usesrname, password FROM admins WHERE usesrname=? and password=?";
    ...
    private void initComponents() {
        ...
        BannerLabel.setIcon(new ImageIcon(LoginScreen.class.getResource("/assets/logo.png"))); // NOI18N
        ...
        LoginButton.setText(bundle.getString("LOG_IN")); // NOI18N
        ...
        ForgotButton.setFont(ForgotButton.getFont().deriveFont(ForgotButton.getFont().getStyle() | java.awt.Font.BOLD, ForgotButton.getFont().getSize()+3));
        ForgotButton.setText(bundle.getString("FORGOT")); 
        ...
        ForgotButton.setPreferredSize(new java.awt.Dimension(180, 40));
    ...
    private void ForgotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
